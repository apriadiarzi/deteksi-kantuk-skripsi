...
with col1:
    ...
    with st.container():
        ...
        with c1:
            ...
            WAIT_TIME = st.slider("Waktu yang dibutuhkan alarm untuk menyala (detik):", 0.0, 5.0, 1.0, 0.25)

        with c2:
            # Lowest valid value of Eye Aspect Ratio. Ideal values [0.15, 0.2].
            EAR_THRESH = st.slider("Ambang Batas Eye Aspect Ratio:", 0.0, 0.4, 0.18, 0.01)
